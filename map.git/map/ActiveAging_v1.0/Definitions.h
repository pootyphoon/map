...
#define UPLOAD_PIC_URL          [BASE_URL stringByAppendingPathComponent:@"uploadImage.php"]


// MARK: EVENTS_URL
#define EVENTS_REGISTER_URL          [BASE_URL stringByAppendingPathComponent:@"eventRegistration.php"]
